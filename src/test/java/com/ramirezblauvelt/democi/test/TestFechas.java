...
public class TestFechas {
	...
	public void testSumarDiasHabilesConFestivosNegativoCambioAnoColombia() {
		Assert.assertEquals(
				...
				Fechas.sumarDiasHabilesConFestivosColombia(LocalDate.of(2019, Month.JANUARY, 10), -12).toString()
		);
	}
	...
	public void testSumarDiasHabilesConFestivosColombiaCero() {
		Assert.assertEquals(
				"No sumó los días hábiles esperados",
				LocalDate.of(2018, Month.DECEMBER, 20).toString(),
				Fechas.sumarDiasHabilesConFestivosColombia(LocalDate.of(2018, Month.DECEMBER, 20), 0).toString()
		);
	}
